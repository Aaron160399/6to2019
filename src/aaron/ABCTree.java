 ...
 * @author bienvenidos
 */
public class ABCTree extends javax.swing.JFrame {
    DefaultMutableTreeNode mainNode = new DefaultMutableTreeNode("letters");
    /**
     * Creates new form ABCTree
     */
    public ABCTree() {
        initComponents();
...
//        jTree2.setCellRenderer(render);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ABCTree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
